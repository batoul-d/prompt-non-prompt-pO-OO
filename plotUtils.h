...
string varFancyLabel(string varLabel="") {
  ...
  fancyLabels["mean0_tauzRes"] = "#tau_{z0;0}";
  fancyLabels["mean1_tauzRes"] = "#tau_{z0;1}";
  fancyLabels["mean2_tauzRes"] = "#tau_{z0;2}";
  fancyLabels["free_mean0_tauzRes"] = "#tau_{z0;0}";
  fancyLabels["free_mean1_tauzRes"] = "#tau_{z0;1}";
  fancyLabels["free_mean2_tauzRes"] = "#tau_{z0;2}";
